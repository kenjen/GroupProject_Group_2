...
@NamedQueries({ 
	...
	@NamedQuery(name = "BaseData.getCountImsiBetweenDates", query = "select b.count(imsi), b.sum(duration), b.imsi from BaseData b where b.date Between :startDate AND :endDate")
})
