...
@NamedQueries({ 
	@NamedQuery(name = "Ue.getCallFailuresDateRange", query = "select COUNT(u.tac), u.tac, u.marketingName from BaseData b, UE u where u.tac = :tac and b.date Between :startDate AND :endDate and b.ueFK = u.id"),
