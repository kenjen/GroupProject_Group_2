...
public class JPAErrorBaseDataDAO implements ErrorBaseDataDAO {
	...
	public Collection<ErrorBaseData> getAllErrorBaseData() {
		Query query = entityManager.createNamedQuery("ErrorBaseData.getAllErrorBaseData");
	...
	public void addAllErrorBaseData(Collection errorBaseDataList) {
		entityManager.createNativeQuery("truncate table error_base_data").executeUpdate();
		entityManager.createNativeQuery("alter table error_base_data AUTO_INCREMENT = 1").executeUpdate();
